            ...
            <div className="prose prose-lg max-w-none text-brand-text-on-light-secondary leading-relaxed space-y-4">
                 <div dangerouslySetInnerHTML={{ 
                     __html: analysis
                        ...
                        .replace(/\*\*(.*?)\*\*/g, '<strong class="text-brand-primary-dark">$1</strong>')
                 }} />
            </div>

            <div className="mt-8 pt-6 border-t border-brand-border flex items-center justify-between text-xs text-brand-text-on-light-secondary opacity-70">
                <span className="flex items-center gap-1"><CheckCircleIcon className="w-4 h-4"/> Validiert durch AI-Logik</span>
                <span className="font-mono text-[10px]">[SASCHA LAGLER | Physio/ML/KI-Developer]</span>
            </div>
        </Card>
    );
};
